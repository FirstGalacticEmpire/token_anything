...
nfts = [NftModel.objects.get_or_create(name="Pinky Ocean",
                                       ...
                                       price=0.08, year_of_production=2021, author_id=1, last_seen_price=0.08, standard='erc721')[0],
        NftModel.objects.get_or_create(name="Deep Sea Phantasy",
                                       description="Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.",
                                       image="images/medium_crs_2.jpg",
                                       price=0.06, year_of_production=2022, author_id=2, last_seen_price=0.08, standard='erc721')[0],
        NftModel.objects.get_or_create(name="Rainbow Style",
                                       description="Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.",
                                       image="images/porto_4.jpg",
                                       price=0.05, year_of_production=2021, author_id=3, last_seen_price=0.08, standard='erc721')[0],
        NftModel.objects.get_or_create(name="Two Tigers",
                                       description="Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.",
                                       image="images/small_big_2.jpg",
                                       price=0.08, year_of_production=2022, author_id=1, last_seen_price=0.08, standard='erc721')[0],
        NftModel.objects.get_or_create(name="The Truth",
                                       description="Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.",
                                       image="images/thumbnail_1.jpg",
                                       price=0.08, year_of_production=2023, author_id=4, last_seen_price=0.08, standard='erc721')[0],
        NftModel.objects.get_or_create(name="Running Puppets",
                                       description="Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.",
                                       image="images/thumbnail_2.jpg",
                                       price=0.08, year_of_production=2020, author_id=2, last_seen_price=0.08, standard='erc721')[0],

        NftModel.objects.get_or_create(name="USA Wordmation",
                                       description="Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.",
                                       image="images/thumbnail_3.jpg",
                                       price=0.07, year_of_production=2021, author_id=3, last_seen_price=0.08, standard='erc721')[0],

        NftModel.objects.get_or_create(name="Loop Donut",
                                       description="Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.",
                                       image="images/thumbnail_crs_5.jpg",
                                       price=0.08, year_of_production=2022, author_id=4, last_seen_price=0.08, standard='erc721')[0]
        ]
